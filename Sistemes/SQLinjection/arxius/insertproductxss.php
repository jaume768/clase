...
<form action='172.20.0.1/insertproductxss.php' method="post">
    <label>Nom</label>
...
if($_POST){
    ...
    $sql2 = "insert into product set name='$nom',  ='$descripcio', price='$preu', observations='$observacions', user_iduser='$user'";
